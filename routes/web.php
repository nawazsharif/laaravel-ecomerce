...
//    Route::get('category', 'CartController@getCategorylist');
    Route::resource('cart', 'CartController');
    Route::get("category/{slug}", 'CategoryController@getCategory')->name('front.category.slug');
//    Route::get("category/{slug}", 'CategoryController@getCategorybrand')->name('front.category.slug');
    Route::get('category/{slug}/category/{brand}', 'CategoryController@getCategorybrand')->name('front.category.brand');
