            ...
            <form action="{{ route('admin.products.store') }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label for="quantity">Top Sell View <span class="text-danger"></span></label>
                            <input type="text" name="topsell" id="topsell" placeholder="want to shoe in top press 1" class="form-control" value="{{ old('topsell') }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <h2>Categories</h2>
